Arguments: 
  /usr/local/Cellar/node/9.11.1/bin/node /usr/local/Cellar/yarn/1.5.1_1/libexec/bin/yarn.js test:mocha

PATH: 
  /usr/local/Cellar/zplug/2.4.2/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:/usr/local/opt/go/libexec/bin:/usr/local/opt/python/libexec/bin:/usr/local/share/dotnet:/usr/local/MacGPG2/bin:/Library/Frameworks/Mono.framework/Versions/Current/Commands
...
npm manifest: 
  {
    ...
    "version": "1.6.2",
    "main": "index.js",
    "repository": "git@github.com:BugFixes/npm.git",
    "author": "Keloran <keloran@bugfix.es>",
    "license": "MIT",
    "description": "NPM for BugFixes so that its easy to integrate into Node projects",
    "scripts": {
      "test": "yarn test:standard && yarn test:mocha",
...
Trace: 
  ...
  Exit code: 1
  Command: sh
  Arguments: -c mocha test/**/*.js
  Directory: /Users/maxhooton/Documents/Projects/BugFixes/NPM
  Output:
